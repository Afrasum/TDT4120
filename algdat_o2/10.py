...
def max_permutations(M):
    ...
    #         continue
    #
    #     if M[start_student] == start_student:
    #         visited.add(start_student)
    #         continue
    #
    #     path = []
    #     current = start_student
    #
    #     while current not in visited and M[current] != current:
    #         if current in path:
    #             cycle = [current]
    #             next_stud = M[current]
    #             while next_stud != current:
    #                 cycle.append(next_stud)
    #                 next_stud = M[next_stud]
    #             result.update(cycle)
    #             break
    #
    #         path.append(current)
    ...
    for start in range(n):
        if visited[start] or M[start] == start:
            visited[start] = True
            continue
        ...
        while not visited[current] and M[current] != current:
            if in_path[current]:
